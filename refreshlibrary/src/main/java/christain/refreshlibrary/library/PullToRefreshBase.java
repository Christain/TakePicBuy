 ...
 *******************************************************************************/
package christain.refreshlibrary.library;
...
import christain.refreshlibrary.R;
import christain.refreshlibrary.internal.FlipLoadingLayout;
import christain.refreshlibrary.internal.LoadingLayout;
import christain.refreshlibrary.internal.RotateLoadingLayout;
import christain.refreshlibrary.internal.Utils;
import christain.refreshlibrary.internal.ViewCompat;
...
//		Log.e("bbbbbb", "cccccccccccccccccc");
//		return true;
//	}
...
//		Log.e("bbbbbb", "bbbbbbbbbbbbbbbb");
//		if (onIntercept(event)) {
...
//		}
	...
	/**
	 * @return Either {@link christain.refreshlibrary.library.PullToRefreshBase.Orientation#VERTICAL} or
	 *         {@link christain.refreshlibrary.library.PullToRefreshBase.Orientation#HORIZONTAL} depending on the scroll direction.
	 */
	 ...
	 * {@link christain.refreshlibrary.library.PullToRefreshBase.State#PULL_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link christain.refreshlibrary.library.PullToRefreshBase.State#REFRESHING} or {@link christain.refreshlibrary.library.PullToRefreshBase.State#MANUAL_REFRESHING} state.
	 * 
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link christain.refreshlibrary.library.PullToRefreshBase.State#RELEASE_TO_REFRESH} state.
	 */
	...
	/**
	 * Called when the UI has been to be updated to be in the
	 * {@link christain.refreshlibrary.library.PullToRefreshBase.State#RESET} state.
	 */
	...
	public static enum Mode {
		 ...
		 * {@link christain.refreshlibrary.library.PullToRefreshBase#setRefreshing() setRefreshing()}.
		 */
	...
	public static interface OnPullEventListener<V extends View> {
		 ...
		 * @param direction - One of {@link christain.refreshlibrary.library.PullToRefreshBase.Mode#PULL_FROM_START} or
		 *            {@link christain.refreshlibrary.library.PullToRefreshBase.Mode#PULL_FROM_END} depending on which direction
		 *            the user is pulling. Only useful when <var>state</var> is
		 *            {@link christain.refreshlibrary.library.PullToRefreshBase.State#PULL_TO_REFRESH} or
		 *            {@link christain.refreshlibrary.library.PullToRefreshBase.State#RELEASE_TO_REFRESH}.
		 */
