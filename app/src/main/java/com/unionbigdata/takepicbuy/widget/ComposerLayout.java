...
public class ComposerLayout extends RelativeLayout {
    ...
    private PathAnimations myani; // 動畫類
        ...
        rlButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (areButtonsShowing) {
                    ...
                    cross.startAnimation(PathAnimations.getRotateAnimation(-360,
                            0, duretime));
                } else {
                    myani.startAnimationsIn(duretime);
                    cross.startAnimation(PathAnimations.getRotateAnimation(0,
                            -360, duretime));
                }
    ...
    public void collapse() {
        myani.startAnimationsOut(duretime);
        cross.startAnimation(PathAnimations.getRotateAnimation(-360, 0, duretime));
